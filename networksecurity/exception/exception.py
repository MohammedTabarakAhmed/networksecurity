...
class NetworkSecurityException():
    ...
    - Without __str__, if you print your object, Python just shows something boring like {{{<NetworkSecurityException object at 0x...>}}}.
    - With __str__, you control the message — you can make it say something useful, like the file name, line number, and error message.
    '''
